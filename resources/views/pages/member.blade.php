                  ...
                  >
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        >
                          <span
                            class="{{ ($agt->jenisKeanggotaan === 'Premium')? 'bg-gradient-to-tl from-emerald-500 to-teal-400 ':'bg-gradient-to-tl from-slate-600 to-slate-300 ' }}px-2.5 text-xs rounded-1.8 py-1.4 inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none text-white"
                            >{{ $agt->jenisKeanggotaan }}</span
                          >
                        </td>
                        <td
